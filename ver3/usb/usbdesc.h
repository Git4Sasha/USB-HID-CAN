...
#define USB_CONFIG_DESC_SIZE        41   // Размер массива с описателем конфигурации устройства
#define HID_REPORT_DESC_SIZE        27   // Размер дескриптора репорта

#define HID_OUT_PACKET_SIZE         32       // Размер пакета принимаемый от хоста (выходящий из хоста)
#define HID_IN_PACKET_SIZE          64       // Размер пакета передаваемый хосту (входящий в хост)

#define USB_INTERFACE_DESC_SIZE     (sizeof(USB_INTERFACE_DESCRIPTOR))
#define USB_ENDPOINT_DESC_SIZE      (sizeof(USB_ENDPOINT_DESCRIPTOR))

#define HID_DESC_OFFSET              18   // Смещение в массиве USB_ConfigDescriptor, с которого начинается HID дискриптор
#define HID_DESC_SIZE                9    // Размер HID дескриптора
